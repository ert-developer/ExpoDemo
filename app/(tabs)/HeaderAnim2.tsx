...
const HeaderAnim2 = () => {
  ...
  const TheadSettingsOptionsList2 = [
    {
  ...
  const disappearingTextAnim = useAnimatedStyle(() => {
    const opacity = interpolate(
      scrollY.value,
      [0, offsetValue],
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      {/* header */}
      <Animated.Text style={[styles.disappearingText, disappearingTextAnim]}>
        This
      </Animated.Text>
      <Animated.View
      ...
      >
        ...
        >
          <Ionicons name="accessibility" color={Colors.white} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.showMoreButton} onPress={() => {}}>
          <Ionicons name="add-circle" color={Colors.white} />
        </TouchableOpacity>
      ...
      >
        ...
        <View style={[styles.addCommunityTab, { backgroundColor: bgColor }]}>
          <View style={styles.iconContainer}>
            <Ionicons name="airplane-outline" color={Colors.light} />
          </View>
